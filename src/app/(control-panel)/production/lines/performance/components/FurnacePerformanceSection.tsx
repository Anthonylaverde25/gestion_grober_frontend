...
export default function FurnacePerformanceSection({ furnace }: FurnacePerformanceSectionProps) {
  ...
  return (
    <section className="border overflow-hidden shadow-none rounded-none mb-16" style={{ backgroundColor: theme.palette.background.paper, borderColor: theme.palette.divider }}>
      <div className="px-10 py-8 border-b flex items-center justify-between" style={{ backgroundColor: headerBg, borderColor: theme.palette.divider }}>
        <div className="flex items-center gap-stack-sm">
          <span className="material-symbols-outlined" style={{ color: theme.palette.primary.main }}>
            heat_pump
          </span>
          <h2 className="font-headline-md text-[20px]" style={{ color: theme.palette.text.primary }}>
            {furnace.name}
          </h2>
          <span
        ...
        <div className="flex items-center gap-10 text-data-tabular">
          <div className="flex flex-col text-right">
            <span className="text-[10px] uppercase font-bold opacity-60" style={{ color: theme.palette.text.secondary }}>
              Líneas de Producción
            </span>
            <span className="font-black text-[18px]" style={{ color: theme.palette.text.primary }}>
              {furnace.machines?.length || 0}
            </span>
          </div>
          <button className="p-2 rounded transition-colors ml-4" style={{ color: theme.palette.primary.main }}>
